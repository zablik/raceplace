...
final class Version20200807141423 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE race (id INT AUTO_INCREMENT NOT NULL, event_id INT NOT NULL, type VARCHAR(255) NOT NULL, name VARCHAR(255) DEFAULT NULL, distance DOUBLE PRECISION DEFAULT NULL, slug VARCHAR(255) NOT NULL, results_source_type VARCHAR(255) NOT NULL, results_source_link VARCHAR(255) NOT NULL, results_source_checkpoints_link VARCHAR(255) NOT NULL, results_source_codes LONGTEXT NOT NULL COMMENT \'(DC2Type:array)\', INDEX IDX_DA6FBBAF71F7E88B (event_id), INDEX type (type), INDEX race_slug (slug), INDEX distance (distance), UNIQUE INDEX race_event_slug (slug, event_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
